...
Weapon_Sword_071:'Master Sword (cutscene version)',
...
Item_Fruit_B_TemporaryOwnedByNpc: 'Wildberry (Link\'s Hateno Farm)',
Item_Fruit_C:'Voltfruit',
Item_Fruit_E:'Fleet-Lotus Seeds',
Item_Fruit_F:'Hydromelon',
Item_Fruit_F_TemporaryOwnedByNpc: 'Hydromelon (Link\'s Hateno Farm)',
...
Item_Fruit_J_TemporaryOwnedByNpc: 'Fortified Pumpkin (Link\'s Hateno Farm)',
Item_Fruit_K:'Acorn',
Item_Fruit_L:'Chickaloo Tree Nut',
Item_Fruit_M:'Hylian Tomato',
Item_Fruit_M_OwnedByNpc: 'Hylian Tomato (Hateno Farm)',
Item_Fruit_M_TemporaryOwnedByNpc: 'Hylian Tomato (Link\'s Hateno Farm)',
Item_Fruit_N:'Sun Pumpkin',
Item_Fruit_N_OwnedByNpc: 'Sun Pumpkin (Hateno Farm)',
Item_Fruit_N_TemporaryOwnedByNpc: 'Sun Pumpkin (Link\'s Hateno Farm)',
...
Item_Ore_A:'Diamond',
Item_Ore_B:'Ruby',
Item_Ore_B_GoronDisplay: 'Ruby (on display)',
Item_Ore_C:'Sapphire',
Item_Ore_D:'Topaz',
Item_Ore_E:'Opal',
Item_Ore_F:'Amber',
...
Item_Ore_N:'Zonaite (unused)',

Item_PlantGet_A:'Hyrule Herb',
Item_PlantGet_B:'Hearty Radish',
Item_Plant_B_TemporaryOwnedByNpc: 'Hearty Radish (NPC owned)',
Item_PlantGet_C:'Big Hearty Radish',
Item_Plant_C_TemporaryOwnedByNpc: 'Big Hearty Radish (NPC owned)',
...
Item_Plant_I_OwnedByNpc: 'Blue Nightshade (NPC owned)',
Item_PlantGet_J:'Silent Princess',
Item_Plant_J_OwnedByNpc: 'Silent Princess (NPC owned)',
Item_PlantGet_L:'Electric Safflina',
Item_PlantGet_M:'Swift Carrot',
Item_Plant_M_OwnedByNpc: 'Swift Carrot (NPC owned)',
Item_Plant_M_TemporaryOwnedByNpc: 'Swift Carrot (NPC owned)',
Item_PlantGet_O:'Swift Violet',
Item_PlantGet_Q:'Endura Carrot',
Item_Plant_Q_TemporaryOwnedByNpc: 'Endura Carrot (NPC owned)',
...
Obj_Camera:'Camera',
Obj_Warp: 'Purah Pad Warp Function',
...
Obj_Photo_Animal: 'Animal Photo (Compendium)',
Obj_Photo_BossEnemy: 'Boss Photo (Compendium)',
Obj_Photo_Enemy: 'Enemy Photo (Compendium)',
Obj_Photo_Material: 'Material Photo (Compendium)',
Obj_Photo_Other: 'Misc Photo (Compendium)',
Obj_Photo_Weapon: 'Weapon Photo (Compendium)',
